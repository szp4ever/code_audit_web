...
/** 按 processId 删除（上传中任务可能尚无 docId） */
export function deleteDocumentByProcessId(processId: string) {
  return request({
...
/** 按 kid + docName 删除 */
export function deleteDocumentByKidAndName(kid: string, docName: string) {
  return request({
